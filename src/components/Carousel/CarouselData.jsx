...
function CarouselData() {
    ...
    const items = [
        <Link to="/herbs"><div data-value="1">
            <img onDragStart={handleDragStart} className='w-full lg:h-[400px] md:h-[300px] h-[250px] ' src={banner1} alt="" />
        </div></Link>
        ,
        <Link to="/map"> <div data-value="2"><img onDragStart={handleDragStart} className='w-full lg:h-[400px] md:h-[300px] h-[250px]' src={banner2} alt="" /></div></Link>,
    ...
    // const clickBot = () => {
    //     let chatbot = document.getElementById('km-popup-close-button')
    //     let chatbotContainer = document.getElementById('launcher-svg-container')
    //     chatbot.setAttribute("display", "flex")
    //     chatbotContainer.classList.add("n-vis")
    // }
